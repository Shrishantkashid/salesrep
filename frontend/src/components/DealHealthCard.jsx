...
const LABEL_STYLES = {
  "Cold":        { bar: "bg-gray-300",   text: "text-gray-500",   bg: "bg-gray-50",   border: "border-gray-200" },
  "Warming up":  { bar: "bg-amber-400",  text: "text-amber-600",  bg: "bg-amber-50",  border: "border-amber-200" },
  "Engaged":     { bar: "bg-blue-400",   text: "text-blue-600",   bg: "bg-blue-50",   border: "border-blue-200" },
  "Hot":         { bar: "bg-green-500",  text: "text-green-700",  bg: "bg-green-50",  border: "border-green-200" },
  "At risk":     { bar: "bg-red-400",    text: "text-red-600",    bg: "bg-red-50",    border: "border-red-200" },
}
    ...
    <div className={`rounded-xl border ${styles.border} ${styles.bg} p-4 mb-4`}>
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold text-gray-700">Deal Health</span>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs text-gray-400 capitalize">{momentum}</span>
        </div>
      </div>
      ...
      {/* Risk */}
      {risk && (
        <div className="flex items-start gap-2 mb-3 p-2 bg-white rounded-lg border border-gray-100">
      ...
      <div className="flex items-start gap-2 mb-3 p-2 bg-white rounded-lg border border-gray-100">
        ...
        <p className="text-xs text-gray-700 font-medium leading-relaxed">{recommended_action}</p>
      </div>

      {/* Confidence */}
      <p className="text-xs text-gray-400 italic">{CONFIDENCE_LABEL[confidence] || CONFIDENCE_LABEL["medium"]}</p>
    </div>
  )
}
